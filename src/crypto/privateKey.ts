...
function leBytesToBelts(bytes: Uint8Array): bigint[] {
  const belts: bigint[] = [];
...
function nonceFor(scalar: U256, pubkey: CheetahPoint, mBelts: bigint[]): U256 {
...
export function signMessage(privateKeyBytes: Uint8Array, message: string): Signature {
