...
const mod256 = (x: bigint): bigint => x & U256_MASK;
...
export const G_ORDER = U256.fromBeBytes(
  new Uint8Array([
    0x7a, 0xf2, 0x59, 0x9b, 0x3b, 0x3f, 0x22, 0xd0, 0x56, 0x3f, 0xbf, 0x0f,
    0x99, 0x0a, 0x37, 0xb5, 0x32, 0x7a, 0xa7, 0x23, 0x30, 0x15, 0x77, 0x22,
    0xd4, 0x43, 0x62, 0x3e, 0xae, 0xd4, 0xac, 0xcf,
  ]),
);
...
export const P_BIG_2 = U256.fromBeBytes(
  new Uint8Array([
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xfe, 0x00, 0x00, 0x00, 0x02,
...
export const P_BIG_3 = U256.fromBeBytes(
  new Uint8Array([
    ...
    0x00, 0x00, 0x00, 0x05, 0xff, 0xff, 0xff, 0xf9, 0x00, 0x00, 0x00, 0x05,
    0xff, 0xff, 0xff, 0xfd, 0x00, 0x00, 0x00, 0x01,
  ]),
);

export const truncGOrder = (digest: bigint[]): U256 => {
